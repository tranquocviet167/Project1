...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_GET['id']))
  {
    ...
    $luong = "SELECT nv.id as idNhanVien, ma_luong, ma_nv, ten_nv, ten_chuc_vu, luong_ngay, luong_thang, ngay_cong, phu_cap, thuc_lanh, khoan_nop, tam_ung, ngay_cham FROM luong l, nhanvien nv, chuc_vu cv WHERE l.nhanvien_id = nv.id AND nv.chuc_vu_id = cv.id AND nv.id = $id ORDER  BY ngay_cham DESC ";
