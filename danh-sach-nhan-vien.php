...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
    ...
    if (isset($_REQUEST['trang_thai'])) {
        $showData = "SELECT id, ma_nv, hinh_anh, ten_nv, gioi_tinh, ngay_tao, ngay_sinh, noi_sinh, so_cmnd, trang_thai FROM nhanvien WHERE trang_thai = 0 ORDER BY id DESC";
    }
