                        ...
                        <div class="small-box bg-aqua">
                            <div class="inner">
                                ...
                                <?php if ($row_acc['quyen']) : ?>
                                    <p><a href="chi-tiet-phong-ban.php?p=department&a=list-department&id=<?php echo $phongban['id']; ?>" class="small-box-footer" style='color: #fff;'>Chi tiết phòng ban <i class="fa fa-arrow-circle-right"></i></a></p>
                                <?php endif; ?>
                            </div>
                            <div class="icon">
