...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
	...
	$nhomNhanVien = "SELECT count(id) as soluong FROM nhom";
	$resultNhomNhanVien = mysqli_query($conn, $nhomNhanVien);
	$rowNhomNhanVien = mysqli_fetch_array($resultNhomNhanVien);
	$tongNhomNhanVien = $rowNhomNhanVien['soluong'];
...
?>
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Tổng quan
				<small>Đề tài BTL | Quản lý nhân sự </small>
			</h1>
			<ol class="breadcrumb">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-orange">
						...
						<a href="danh-sach-phong-ban.php?p=department" class="small-box-footer">Danh sách phòng ban <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-lg-3 col-xs-6">
				...
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-red">
						...
						<a href="danh-sach-nhan-vien.php?p=staff&a=list-staff&trang_thai=nghi-viec" class="small-box-footer">Danh sách nghỉ việc <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<div class="col-lg-3 col-xs-6">
					<!-- small box -->
					<div class="small-box bg-teal">
						<div class="inner">
							<h3><?php echo $tongNhomNhanVien; ?></h3>
							<p>Nhóm nhân viên</p>
						</div>
						<div class="icon">
							<i class=" fa fa-users"></i>
						</div>
						<a href="danh-sach-nhom.php?p=group&a=list-group" class="small-box-footer">Danh sách nhóm nhân viên <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-lg-3 col-xs-6">
				...
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-green">
						...
						<a href="export_lich_cong_tac.php" class="small-box-footer">Lịch công tác <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<div class="col-lg-3 col-xs-6">
					<!-- small box -->
					<div class="small-box bg-green">
						...
						<a href="export_khen_thuong.php" class="small-box-footer">Khen thưởng <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<div class="col-lg-3 col-xs-6">
					<!-- small box -->
					<div class="small-box bg-green">
						...
						<a href="export_ky_luat.php" class="small-box-footer">Kỷ luật <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
			</div>
			<!-- /.row -->
