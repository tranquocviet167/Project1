...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
	...
	if (isset($_POST['edit'])) {
		$id = $_POST['idRoom'];
		echo "<script>location.href='sua-phong-ban.php?p=department&a=room&id=" . $id . "'</script>";
	}
	...
	if (isset($_POST['save'])) {
		...
		if (!$error) {
			...
			echo '<script>setTimeout("window.location=\'danh-sach-phong-ban.php?p=department&a=room\'",1000);</script>';
		}
	}
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $row_acc['ho'];
																													echo " ";
																													echo $row_acc['ten']; ?>" name="personCreate" readonly>
										</div>
										<div class="form-group">
