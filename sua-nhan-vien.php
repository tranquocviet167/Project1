  ...
  if(isset($_GET['id']))
  {
    ...
    // set value option another
      if ($qt_id) {
          ...
          $qt = "SELECT id, ten_quoc_tich FROM quoc_tich";
      }
    ...
    while ($rowQT = mysqli_fetch_array($resultQT)) 
    {
      ...
      if ($tg_id) {
          ...
          $tg = "SELECT id, ten_ton_giao FROM ton_giao";
      }
    ...
    while ($rowTG = mysqli_fetch_array($resultTG)) 
    {
      ...
      if ($dt_id) {
          ...
          $dt = "SELECT id, ten_dan_toc FROM dan_toc ";
      }
    ...
    while ($rowDT = mysqli_fetch_array($resultDT)) 
    {
      ...
      if ($nv_id) {
          ...
          $lnv = "SELECT id, ten_loai_nv FROM loai_nv";
      }
    ...
    while ($rowLNV = mysqli_fetch_array($resultLNV)) 
    {
      ...
      if ($bc_id) {
          ...
          $bc = "SELECT id, ten_bang_cap FROM bang_cap";
      }
    ...
    while ($rowBC = mysqli_fetch_array($resultBC)) 
    {
      ...
      if ($cv_id) {
          ...
          $cv = "SELECT id, ten_chuc_vu FROM chuc_vu";
      }
    ...
    while ($rowCV = mysqli_fetch_array($resultCV)) 
    {
      ...
      if ($td_id) {
          ...
          $td = "SELECT id, ten_trinh_do FROM trinh_do";
      }
    ...
    while ($rowTD = mysqli_fetch_array($resultTD)) 
    {
      ...
      if ($cm_id) {
          ...
          $cm = "SELECT id, ten_chuyen_mon FROM chuyen_mon";
      }
    ...
    while ($rowCM = mysqli_fetch_array($resultCM)) 
    {
      ...
      if ($hn_id) {
          ...
          $hn = "SELECT id, ten_tinh_trang FROM tinh_trang_hon_nhan";
      }
