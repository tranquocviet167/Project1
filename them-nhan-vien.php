    ...
    if (isset($_POST['save'])) {
        ...
        if (!$error) {
            if ($hinhAnh) {
                ...
                // insert data
                $insert = "INSERT INTO nhanvien(ma_nv, hinh_anh, ten_nv, biet_danh, gioi_tinh, ngay_sinh, noi_sinh, hon_nhan_id, so_cmnd, noi_cap_cmnd, ngay_cap_cmnd, nguyen_quan, quoc_tich_id, ton_giao_id, dan_toc_id, ho_khau, tam_tru, loai_nv_id, trinh_do_id, chuyen_mon_id, bang_cap_id, chuc_vu_id, trang_thai, nguoi_tao_id, ngay_tao, nguoi_sua_id, ngay_sua) 
        VALUES('$maNhanVien', '$imageName', '$tenNhanVien', '$bietDanh', '$gioiTinh', '$ngaySinh', '$noiSinh', '$honNhan', '$CMND', '$noiCap', '$ngayCap', '$nguyenQuan', '$quocTich', '$tonGiao', '$danToc', '$hoKhau', '$tamTru', '$loaiNhanVien', '$trinhDo', '$chuyenMon', '$bangCap', '$chucVu', '$trangThai', '$id_user', '$ngayTao', '$id_user', '$ngayTao')";
                ...
                // insert data
                $insert = "INSERT INTO nhanvien(ma_nv, hinh_anh, ten_nv, biet_danh, gioi_tinh, ngay_sinh, noi_sinh, hon_nhan_id, so_cmnd, noi_cap_cmnd, ngay_cap_cmnd, nguyen_quan, quoc_tich_id, ton_giao_id, dan_toc_id, ho_khau, tam_tru, loai_nv_id, trinh_do_id, chuyen_mon_id, bang_cap_id, chuc_vu_id, trang_thai, nguoi_tao_id, ngay_tao, nguoi_sua_id, ngay_sua) 
        VALUES('$maNhanVien', '$hinhAnh', '$tenNhanVien', '$bietDanh', '$gioiTinh', '$ngaySinh', '$noiSinh', '$honNhan', '$CMND', '$noiCap', '$ngayCap', '$nguyenQuan', '$quocTich', '$tonGiao', '$danToc', '$hoKhau', '$tamTru', '$loaiNhanVien', '$trinhDo', '$chuyenMon', '$bangCap', '$chucVu', '$trangThai', '$id_user', '$ngayTao', '$id_user', '$ngayTao')";
                $result = mysqli_query($conn, $insert);
                if ($result) {
                    $success['success'] = 'Thêm nhân viên thành công';
                    echo '<script>setTimeout("window.location=\'them-nhan-vien.php?p=staff&a=add-staff\'",1000);</script>';
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small style="color: red;"><?php if (isset($error['honNhan'])) {
                                                                            echo "Vui lòng chọn tình trạng hôn nhân";
                                                                        } ?></small>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small style="color: red;"><?php if (isset($error['noiCap'])) {
                                                                            echo "Vui lòng nhập nơi cấp";
                                                                        } ?></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small style="color: red;"><?php if (isset($error['quocTich'])) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small style="color: red;"><?php if (isset($error['danToc'])) {
                                                                            echo "Vui lòng chọn dân tộc";
                                                                        } ?></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small style="color: red;"><?php if (isset($error['loaiNhanVien'])) {
                                                                            echo "Vui lòng chọn loại nhân viên";
                                                                        } ?></small>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small style="color: red;"><?php if (isset($error['hoKhau'])) {
                                                                            echo "Vui lòng nhập hộ khẩu";
                                                                        } ?></small>
                                        </div>
                                        <div class="form-group">
                                            <label>Tạm trú: </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small style="color: red;"><?php if (isset($error['trinhDo'])) {
                                                                            echo "Vui lòng chọn trình độ";
                                                                        } ?></small>
                                        </div>
                                        <div class="form-group">
