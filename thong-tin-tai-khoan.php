            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Mã nhân viên <b style="color: red;">*</b></label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" placeholder="Mã nhân viên" value="<?php echo $row_acc['ma_nv']; ?>" readonly name="lastName">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Họ <b style="color: red;">*</b></label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" placeholder="Nhập họ" value="<?php echo $row_acc['ho']; ?>" readonly name="lastName">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label">Tên <b style="color: red;">*</b></label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail" placeholder="Nhập tên" readonly value="<?php echo $row_acc['ten']; ?>" name="firstName">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail" placeholder="Nhập số điện thoại" disabled name="phone" value="<?php echo $row_acc['so_dt']; ?>">
                    </div>
                  </div>
                  <?php
                  // show for admin
